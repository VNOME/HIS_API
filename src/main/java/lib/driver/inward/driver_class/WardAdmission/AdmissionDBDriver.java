...
public class AdmissionDBDriver {
	...
	public boolean insertWardAdmission(Admission admission,int pid,int docID,int createUser,int UpdateUser) {
		...
		try {
			...
			System.out.println("hellowwwwwwwww");
	...
	public boolean updateDischarge(String BhtNo, String discharjType,String remark,int LastUpdatedUser,Date LastUpdatedDateTime){
		Transaction tx=null;
