...
public class HrEmployeeResource {
	...
	public String AddNewEmployee(JSONObject wJson)  // json object calling here
	{
	...
	@Produces(MediaType.APPLICATION_JSON)
	public String GetEmployeesByID(@PathParam("data")  int empId) { // eka parameter ekak ena eka
				
		try {
			List<HrEmployeeView> empList=hrEmployeeDBDriver.GetEmployeesByID(empId); // dbaccess
	...
	@GET
	@Path("/getNextEmployeeID1")
	@Produces(MediaType.APPLICATION_JSON)
	public String GetNextEmployeeID1() {
